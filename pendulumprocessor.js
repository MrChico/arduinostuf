...
//		const err = Payload.verify(gd);
		...
		// }
//	    Max.updateDict("pitch", pitchLPF);
	    Max.updateDict("orientation", "pitch", pitchLPF);
	    Max.updateDict("orientation", "roll", rollLPF);
	    Max.updateDict("orientation", "yaw", yawLPF);
